...
<title>Diamonds - David Westhead - Professional Artist and Lecturer</title>  
...
<div class="container">
  ...
  <div class="container">
        ...
        <p>Here, I'm drawn to the diamond format, used throughout art history from the heraldic achievements of Tudor times to the late works of Mondrian. Diagonals provide dynamic possibilities restricted by the horizontal and vertical edges of normal rectangular canvases. </p>
        
        <p>These images develop deep spatial effects without any recourse to figurative subject matter. Baroque ceilings using the technique of sotto-in-su (from below upwards) for extreme illusionism, have always interested me.</p>
        ...
        <p>All paintings in this series are 80cm x 80cm and are acrylic on canvas. <a href="../prices#Diamonds">View price list</a>.</p>
