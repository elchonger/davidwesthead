...
<title>Works on paper small - David Westhead - Professional Artist and Lecturer</title>  
...
<div class="container">
  ...
  <div class="container">
        ...
        <p>This series of small, quickly executed paintings are inspired by the Dorset coast. Some border on the abstract while others have a 'done on the spot' appearance. However all were made in the studio from memory. I like to work in this way - the memory jettisons the pictorially unnecessary and one is left only the essence of a scene.</p>
        ...
        <p>All paintings in this series are 40cm x 60cm and use a variety of mixed-media. <a href="../prices#WorksonPaperSmall">View prices</a>.</p>
