    ...
    function Plugin(element, options) {
        ...
        this._printGallery = function(photos) {
            ...
            $.each(photos, function(key, photo) {
                var img = $('<img>', { 'title': photo.title, 'class': 'thumb img-thumbnail img-responsive', src: photo.thumbnail });
                element.append($('<div></div>', { 'class': 'col-lg-2 col-md-3 col-xs-6 col-center' })
